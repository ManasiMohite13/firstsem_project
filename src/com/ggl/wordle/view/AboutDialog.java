...
public class AboutDialog extends JDialog {
	...
	private JPanel createMainPanel() {
		...
		gbc.gridx = 0;
		gbc.gridy = 0;
		JLabel label = new JLabel("About Word Game");
		...
		gbc.gridy++;
		String text = "A Word Game is created by First Year MCA student"+" persuing degree from SIOM.";
		...
		gbc.gridx++;
		label = new JLabel("Manasi Sunil Mohite");
		label.setFont(textFont);
		panel.add(label, gbc);
		...
		gbc.gridx++;
		label = new JLabel("22 November 2023");
		label.setFont(textFont);
		panel.add(label, gbc);
